      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="mt-4 pt-4 border-t border-border flex items-end justify-between gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center px-3 py-1.5 rounded-md bg-primary text-primary-foreground text-xs font-semibold hover:bg-primary-hover transition-smooth"
          >
            {t("cta.viewDetails")}
          </Link>
        </div>
